...
### 3. `inject_swagger_docs.py`

Script tự động inject Swagger documentation vào các route functions:
- Được gọi tự động khi server khởi động
- Inject docstrings từ `swagger_specs.py` vào các route functions
- Xử lý tất cả routes trong `machine_routes.py` và `reference_routes.py`
...
- `POST /api/images` - Upload và OCR
- `GET /api/images` - List images
- `GET /api/images/<filename>` - Get image
- `DELETE /api/images/<filename>` - Delete image
- `GET /api/images/processed_roi/<filename>` - Processed ROI
- `GET /api/images/hmi_refined/<filename>` - HMI refined
- `GET /api/images/aligned/<filename>` - Aligned image
- `GET /api/images/hmi_detection/<filename>` - HMI detection

### Decimal Places (10 endpoints)
- `GET /api/decimal_places` - All config
- `POST /api/decimal_places` - Update config
- `GET /api/decimal_places/<machine_code>` - By machine
- `GET /api/decimal_places/<machine_code>/<screen_name>` - By screen
- `POST /api/decimal_places/<machine_code>/<screen_name>` - Update screen
- `POST /api/set_decimal_value` - Set single value
- `POST /api/set_all_decimal_values` - Set all values
- `GET /api/decimal_places/<machine_type>/Reject_Summary/<machine_code>` - Reject Summary machine
- `GET /api/decimal_places/<machine_type>/Reject_Summary/<machine_code>/<sub_page>` - Reject Summary sub-page
- `POST /api/decimal_places/<machine_type>/Reject_Summary/<machine_code>/<sub_page>` - Update sub-page
